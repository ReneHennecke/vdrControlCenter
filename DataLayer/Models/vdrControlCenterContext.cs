...
public partial class vdrControlCenterContext : DbContext, IDataProtectionKeyContext
{
    ...
    {
        var converter = new ProtectedConverter(_dataProtectionProvider);
        ...
        modelBuilder.Entity<Station>(entity =>
        {
            ...
            entity.Property(e => e.PathToRecordings)
                .HasMaxLength(255);

            entity.Property(e => e.SambaPassword)
                .HasMaxLength(1024)
                .HasConversion(converter);

            entity.Property(e => e.SambaUserName)
                .HasMaxLength(30);
            ...
            entity.Property(e => e.VdradminPort)
